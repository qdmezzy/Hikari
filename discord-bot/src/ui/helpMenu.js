...
const categories = [
  ...
  },
  {
    ...
    body: [
      "`/watching [user]` — What you're watching",
      "`/add <anime>` — Add a title to your list",
      "`/status <anime> <state>` — Set a status",
      "`/progress <anime> <number>` — Set episode",
      "`/plusone [anime]` — +1 episode",
      "`/remove <anime>` · `/undo` — Fix mistakes",
    ],
  },
  {
    key: "discover",
