                ...
                {isMod ? (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-jp text-[11px] tracking-[0.3em] text-primary/70">まとめ（モッド限定）</p>
                        <p className="font-bold text-foreground">Your {new Date().getFullYear()} Wrapped (mod preview)</p>
