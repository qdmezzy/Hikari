...
import { fetchAniList, formatAniListStatus, getEpisodeCount, getMediaHref, getMediaTitle, getPrimaryStudio } from "@/lib/anilist"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Search AniList live instead of cycling through the old demo titles.
            </p>
          </motion.div>
