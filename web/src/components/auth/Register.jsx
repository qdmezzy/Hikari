...
import { Sparkles, Mail, Lock, User, Eye, EyeOff, Check, AtSign } from 'lucide-react';
import { cn } from '@/lib/utils';
import { checkHandleAvailability, normalizeHandle } from '@/lib/public-profile';
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const handleValue = normalizeHandle(handle);
            if (!handleValue) {
            ...
            if (!available) {
                setError(`@${handleValue} is already taken.`);
                setLoading(false);
                return;
            }
    ...
    const handleOAuthSignIn = async (provider) => {
        ...
        if (oauthError) {
            if (isExistingAccountOauthError(oauthError.message)) {
                setError('This email already has an account. Sign in from the login page to link this provider.');
            } else {
    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-4 py-12">
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-1/3 right-1/3 w-96 h-96 bg-primary/15 rounded-full blur-[120px]" />
            </div>
            ...
            <div className="relative w-full max-w-md">
                ...
                <Card className="bg-card/80 backdrop-blur-xl border-border/50 shadow-2xl overflow-hidden">
                    ...
                    <CardHeader className="text-center pt-8 pb-4">
                        ...
                        <CardDescription>Start tracking your anime journey today</CardDescription>
                    </CardHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        />
                                                ...
                                                >
                                                    <div
                                                        className={cn(
                                                            ...
                                                            passed ? "bg-emerald-500/20" : "bg-secondary",
                                                        )}
                                                    >
                            ...
                            <Button
                        type="submit"
                                className="w-full h-12 rounded-xl bg-gradient-to-r from-primary to-accent hover:opacity-90 transition-opacity text-base font-medium mt-2"
                        disabled={loading}
                            >
                                {loading ? (
